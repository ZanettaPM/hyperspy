...
class EDSModel(Model1D):
    ...
    def add_physical_background(self, E0='from_metadata', detector='Polymer_C', quantification=None,absorption_model='quadrilateral', coating_thickness=0):
        """
        ...
        background = create_component.Physical_background(E0=E0,detector=detector, quantification=quantification, absorption_model=absorption_model, coating_thickness=coating_thickness)
